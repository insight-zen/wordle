...
export const Wordle = {
  ...
  submitGuess(){
    ...
    if (!dictionary.includes(guess)) {
      this.showAlert({message: "Not in word list"})
      this.shakeTiles(activeTiles)
      return
    }
...
// window.wl.alertContainer = alertContainer
// window.wl.guessGrid = guessGrid
// window.wl.keyBoard = keyBoard
// window.wl.replayButton = replayButton
